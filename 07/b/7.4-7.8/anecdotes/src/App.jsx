...
import { useField, useEmptyOnChange } from "./hooks"
...
const CreateNew = (props) => {
  ...
  const onChanges = [content.onChange, author.onChange, info.onChange]
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button onClick={(e) => {
          e.preventDefault()
          onChanges.forEach(onChange => useEmptyOnChange(onChange))
          }}>reset</button>
      </form>
    </div>
  )
